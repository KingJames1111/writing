...
- 	Hooks to reuse:
  - 	“We don’t count what you almost had.”
  - 	“Trade 2 hours. Cash the milestone.”
...
- 	Hooks to reuse:
  - 	“Two losses end the session—not the week.”
  - 	“Discipline becomes deposit.”
...
- 	Hooks to reuse:
  - 	“Trailing for momentum. EOD for breathing room.”
  - 	“Telemetry over superstition.”
...
- 	Hooks to reuse:
  - 	“Keep speed. Keep edge. Lose the gotchas.”
  - 	“Proof over pageantry.”
...
- 	Primary CTA by tier:
  - 	Beginner: Start Signature QuickStart
  - 	Intermediate: Lock 2-Hour Session
  - 	Advanced: Compare EOD vs Trailing
  - 	Pro: Confirm Payout Rails
...
- 	Rule shield:
  - 	EOD (closed-balance): calculates against yesterday’s closed balance → pullbacks breathe; no phantom liquidation.
  - 	Trailing (peak-following): ratchets with intraday equity highs → momentum feel; respects new peaks.
...
- 	Neutralizers (what we show):
  - 	Protective risk model: EOD or Trailing (plain-English trade-offs).
  - 	Milestone rhythm: Hit target → Withdraw → Continue (show $ near %).
  - 	Payout proof: USD bank transfer or crypto after $1 wallet verification (crypto rails only).
  - 	Discipline aids: max-3 decisions, cool-down locks, plan-adherence streaks.
  - 	Community + analytics: millisecond journaling; edge-vs-variance tiles.
...
4.	Rules that protect (choose your runway)
  - 	EOD (closed-balance): preserves good trades through normal pullbacks; no phantom liquidation.
  - 	Trailing (peak-following): tightens as you print new highs; suits momentum playbooks.
...
- 	Self-talk moments:
  - 	“Spread widened—skip.”
  - 	“Break-even at +0.7R. Let it work.”
  - 	“Flat protects the milestone.”
...
1.	Primary: Simulated Finance vs Prop Firms
  - 	Supporting: What Is Simulated Finance (SimFi)? • Why We Avoid “Funded Accounts” Language • Performance-Based Payouts Explained
2.	Primary: EOD vs Trailing Risk — Plain English
  - 	Supporting: Closed-Balance Math for EOD • Peak-Following Logic for Trailing • Which Risk Model Fits Your Playbook?
3.	Primary: Milestone Math (with $ near %)
  - 	Supporting: Illustration: 2.5% on $10k/$50k/$100k • Why Smaller, Frequent Withdrawals Build Trust • Process Over Outcome: Max-3 Decisions & Cool-Downs
4.	Primary: Payout Rails: Bank & Crypto (with $1 Verification)
  - 	Supporting: Bank Transfer Timeline • Crypto Wallet One-Time $1 Verification (crypto rails only) • Payout Proof Objects and Transparency
5.	Primary: Configurator Guide (Balance • Drawdown • Payout Share)
  - 	Supporting: Change One Variable for Ten Sessions • Instrument Caps (2–3) for Signal Purity • Platform Continuity: Match-Trader, cTrader, TradeLocker (availability varies)
6.	Primary: Forex vs Crypto vs Futures — Which Path First?
  - 	Supporting: Event-Day Protocol (Forex/Futures) • Weekend Crypto Curfew • Futures Rollover: Why Positions Liquidate at Rollover
